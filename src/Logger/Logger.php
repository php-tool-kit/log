...
class Logger implements LoggerInterface
{
    ...
    protected function getFormatterForLevel(string $level): FormatterInterface
    {
    ...
    protected function getWriterForLevel(string $level): WriterInterface
    {
    ...
    public function setFormatterForLevel(string $level, FormatterInterface $formatter): void
    {
        $this->formatters[$level] = $formatter;
    }

    public function setWriterForLevel(string $level, WriterInterface $writer): void
    {
